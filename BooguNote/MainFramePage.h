...
public:
	...
	CComboBox m_cbCAPTION_CHANGE_RULE;
    ...
    BEGIN_DDX_MAP(CMainFramePage)
		...
		DDX_UINT_RANGE(IDC_SAVEALL_ELAPSE, nSaveAllElapse, 0, 10000)
		...
		DDX_COMBO_INDEX(IDC_COMBO_CAPTION_CHANGE_RULE, g_config.nCAPTION_CHANGE_RULE)
    END_DDX_MAP()
