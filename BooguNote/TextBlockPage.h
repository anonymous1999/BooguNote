...
public:
	...
	BEGIN_DDX_MAP(CTextBlockPage)
		...
		DDX_CHECK(IDC_CHECK_ENABLE_CHANGE_TO_RELATIVEPATH, g_config.bEnterCHANGE_TO_RELATIVEPATH)
		DDX_CHECK(IDC_CHECK_ENABLE_SHOW_RAW_PATH, g_config.bEnterSHOW_RAW_PATH)
